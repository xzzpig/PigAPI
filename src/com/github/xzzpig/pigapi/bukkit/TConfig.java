...
public class TConfig {
	public static FileConfiguration getConfigFile(String pl, String filename) {
		...
		file = new File(Bukkit.getPluginManager().getPlugin(pl).getDataFolder()
				.toString()
				+ "/" + filename);
		if (!file.exists())
			try {
	...
	public static void saveConfig(String pl, FileConfiguration configfile,
			String filename, String arg0, Object arg1) {
	...
	public static void saveConfig(String pl, String filename, String arg0,
			Object arg1) {
